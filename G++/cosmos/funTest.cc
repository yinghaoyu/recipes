...
struct Members<Aggregate> {
  using type =
      Pack<MemberBinding<decltype(&Aggregate::member1), &Aggregate::member1>,
...
/// General case
template <typename A, typename MT, MT MPTR, typename... Rest, std::size_t I0,
          std::size_t... I>
void printPack(std::ostream& out, const A& v,
               Pack<MemberBinding<MT, MPTR>, Rest...>*,
...
void to_str_impl(std::ostream& out, const T& v,
  ...
  printPack(out, v, (typename M::type*)nullptr,
            std::make_index_sequence<Members<T>::value>{});
  out << ')';
}
...
// get field by index, name;get field name and method name; invoke by method
// name;
